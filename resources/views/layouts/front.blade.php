...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="src="/images/media/imgpsh_fullsize_anim.jpg" type="image/x-icon">
    <link rel="icon" href="/images/media/imgpsh_fullsize_anim.jpg" type="image/x-icon">
        ...
        <div class="header__content__venor">
            <div class="header__logo">
                <a href="{{url('/')}}" title="{{$setting->title}}">
                    <img width="105" height="22" class="img-fluid logo-front" src="/images/media/ARTEX-LOGO.svg" alt="logo">
                </a>
            </div>
            ...
            <div class="header__actions__venor">
                ...
                <div class="header__action">
                    <a  class="header__action-btn header__action-btn--start-project" href="/contact">
                        Contact <svg width="11.4" height="9.2"> <use xlink:href="#arrow"></use></svg>
                    </a>
                </div>
                @endif
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 text-right">
                    <a href="/contact" target="_self" class="btn btn-style1"><span>{{$headerfooter->typed_buttontext}}</span><svg width="11.4" height="9.2"> <use xlink:href="#arrow"></use></svg></a>
                </div>
            </div>
        </div>
    </div>   
...
<ul class="ft-link">
<li><a href="/">contact@artexdesigns.com</a></li>
</ul>
<div class="social-share-inner">
<ul class="social-share">
<li><a target="_blank" rel="noopener" href="https://www.instagram.com/artexdesignss/"><em class="fab fa-instagram"><strong>behance</strong></em></a></li>
<li><a href="https://www.behance.net/artexdesignss" target="_blank" rel="noopener"><em class="fab fa-behance"><strong>behance</strong></em></a></li>
<li><a href="https://twitter.com/artexdesignss" target="_blank" rel="noopener"><em class="fab fa-twitter"><strong>instagram</strong></em></a></li>
