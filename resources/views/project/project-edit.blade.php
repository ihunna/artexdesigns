                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.photo') , array('Attr.EnableID' => true))}} 5</strong>
                                                 <img class="img-fluid pb-4" width="100" height="100" src="{{$project->img_gal5 ? $project->img_gal5 : '/img/200x200.png'}}">
                                                <input type="text" name="img_gal5" class="form-control" placeholder="" value="{{$project->img_gal5}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.photo') , array('Attr.EnableID' => true))}} 6</strong>
                                                 <img class="img-fluid pb-4" width="100" height="100" src="{{$project->img_gal6 ? $project->img_gal6 : '/img/200x200.png'}}">
                                                <input type="text" name="img_gal6" class="form-control" placeholder="" value="{{$project->img_gal6}}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.photo') , array('Attr.EnableID' => true))}} 7</strong>
                                                 <img class="img-fluid pb-4" width="100" height="100" src="{{$project->img_gal7 ? $project->img_gal7 : '/img/200x200.png'}}">
                                                <input type="text" name="img_gal7" class="form-control" placeholder="" value="{{$project->img_gal7}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.photo') , array('Attr.EnableID' => true))}} 8</strong>
                                                 <img class="img-fluid pb-4" width="100" height="100" src="{{$project->img_gal8 ? $project->img_gal8 : '/img/200x200.png'}}">
                                                <input type="text" name="img_gal8" class="form-control" placeholder="" value="{{$project->img_gal8}}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.photo') , array('Attr.EnableID' => true))}} 9</strong>
                                                 <img class="img-fluid pb-4" width="100" height="100" src="{{$project->img_gal9 ? $project->img_gal9 : '/img/200x200.png'}}">
                                                <input type="text" name="img_gal9" class="form-control" placeholder="" value="{{$project->img_gal9}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.photo') , array('Attr.EnableID' => true))}} 10</strong>
                                                 <img class="img-fluid pb-4" width="100" height="100" src="{{$project->img_gal10 ? $project->img_gal10 : '/img/200x200.png'}}">
                                                <input type="text" name="img_gal10" class="form-control" placeholder="" value="{{$project->img_gal10}}">
                                            </div>
                                        </div>
                                    </div>
