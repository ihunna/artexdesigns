      ...
      <div class="col-md-6">
        ...
        <form method="POST" action="{{route('contactPost')}}">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                <input name="email" type="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="{!!$contactsetting->form_input_email!!}">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                <input name="budget" type="text" class="form-control" id="budget" aria-describedby="emailHelp" placeholder="{!!$contactsetting->form_input_phone!!}">
