		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="venor-price-box @if($pricing->pricing_switch == 1) premium-pricing @endif">
					@if($pricing->pricing_switch == 1) <div class="plan-ribbon-wrapper">
						<div class="plan-ribbon">{{$pricing->popular_text}}</div>
					</div> @endif
					{!!$pricing->title!!}
					...
					<div class="project-button">
						<a href="{{$pricing->button_link}}" title="Web Design"><span>{{$pricing->button_text}}</span><svg viewBox="0 0 80 80">
