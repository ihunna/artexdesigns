            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 maintenance_radio">
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="maintenance_status" id="maintenance_status1" value="1" @if($setting->maintenance_status == 1) checked @endif>
                    <label class="form-check-label" for="maintenance_status1"> {{clean( trans('niva-backend.on') , array('Attr.EnableID' => true))}} </label>
                  </div>

                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="maintenance_status" id="maintenance_status0" value="0" @if($setting->maintenance_status == 0) checked @endif>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="loader_status" id="loader_status1" value="1" @if($setting->loader_status == 1) checked @endif>
                    <label class="form-check-label" for="loader_status1"> {{clean( trans('niva-backend.on') , array('Attr.EnableID' => true))}} </label>
                  </div>

                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="loader_status" id="loader_status0" value="0" @if($setting->loader_status == 0) checked @endif>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="OGgraph_switch" id="OGgraph_switch1" value="1" @if($setting->OGgraph_switch == 1) checked @endif>
                    <label class="form-check-label" for="OGgraph_switch1"> {{clean( trans('niva-backend.on') , array('Attr.EnableID' => true))}} </label>
                  </div>

                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="OGgraph_switch" id="OGgraph_switch0" value="0" @if($setting->OGgraph_switch == 0) checked @endif>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="analytics_switch" id="analytics_switch1" value="1" @if($setting->analytics_switch == 1) checked @endif>
                    <label class="form-check-label" for="analytics_switch1"> {{clean( trans('niva-backend.on') , array('Attr.EnableID' => true))}} </label>
                  </div>

                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="analytics_switch" id="analytics_switch0" value="0" @if($setting->analytics_switch == 0) checked @endif>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="facebook_pixel_switch" id="pixel_switch1" value="1" @if($setting->facebook_pixel_switch == 1) checked @endif>
                    <label class="form-check-label" for="pixel_switch1"> {{clean( trans('niva-backend.on') , array('Attr.EnableID' => true))}} </label>
                  </div>

                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="facebook_pixel_switch" id="pixel_switch0" value="0" @if($setting->facebook_pixel_switch == 0) checked @endif>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="SchmeaORG_switch" id="schema_switch1" value="1" @if($setting->SchmeaORG_switch == 1) checked @endif>
                    <label class="form-check-label" for="schema_switch1"> {{clean( trans('niva-backend.on') , array('Attr.EnableID' => true))}} </label>
                  </div>

                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="SchmeaORG_switch" id="schema_switch0" value="0" @if($setting->SchmeaORG_switch == 0) checked @endif>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="whatsapp" id="enable_disable_whatsapp1" value="1" @if($setting->whatsapp == 1) checked @endif>
                    <label class="form-check-label" for="enable_disable_whatsapp1"> {{clean( trans('niva-backend.on') , array('Attr.EnableID' => true))}} </label>
                  </div>

                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="whatsapp" id="enable_disable_whatsapp0" value="0" @if($setting->whatsapp == 0) checked @endif>
