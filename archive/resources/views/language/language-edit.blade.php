              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="is_default" id="on_off_sublanguage1" value="1" @if($language->is_default == 1) checked @endif>
                    <label class="form-check-label" for="on_off_sublanguage1"> {{clean( trans('niva-backend.yes') , array('Attr.EnableID' => true))}} </label>
                  </div>

                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="is_default" id="on_off_sublanguage0" value="0" @if($language->is_default == 0) checked @endif>
                ...
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="rtl" id="on_off_sublanguage1" value="1" @if($language->rtl == 1) checked @endif>
                    <label class="form-check-label" for="on_off_sublanguage1"> {{clean( trans('niva-backend.yes') , array('Attr.EnableID' => true))}} </label>
                  </div>

                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="rtl" id="on_off_sublanguage0" value="0" @if($language->rtl == 0) checked @endif>
                    <label class="form-check-label" for="on_off_sublanguage0"> {{clean( trans('niva-backend.no') , array('Attr.EnableID' => true))}} </label>
                  </div>
