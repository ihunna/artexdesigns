    ...
    <div class="container">
        <div class="row align-items-center">
                ...
                <div class="simpleParallax-video">
                    ...
                    <a class="popup-vimeo-video" href="{{$aboutsetting->about_ytlink}}">
                        <svg enable-background="new 0 0 30.051 30.051" version="1.1" viewBox="0 0 30.051 30.051" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
                            <path d="m19.982 14.438-6.24-4.536c-0.229-0.166-0.533-0.191-0.784-0.062-0.253 0.128-0.411 0.388-0.411 0.669v9.069c0 0.284 0.158 0.543 0.411 0.671 0.107 0.054 0.224 0.081 0.342 0.081 0.154 0 0.31-0.049 0.442-0.146l6.24-4.532c0.197-0.145 0.312-0.369 0.312-0.607 1e-3 -0.242-0.117-0.465-0.312-0.607z" />
            ...
            <div class="col-md-7">
                ...
                <a href="{{$aboutsetting->about_buttonlink}}" target="_self" class="btn btn-style1"><span>{{$aboutsetting->about_buttontext}}</span><svg width="11.4" height="9.2">
