            ...
            <div class="container">
                ...
                <div class="slider-content">
                    ...
                    <div class="button-slider-b">
                        <a href="{!!$slido->button_link!!}" target="_self" class="btn btn-slider"><span>{!!$slido->button_text!!}</span><svg width="11.4" height="9.2">
                    ...
                    <div class="button-slider-b">
                        <a href="{!!$slido->button_link2!!}" target="_self" class="btn btn-slider"><span>{!!$slido->button_text2!!}</span><svg width="11.4" height="9.2">
                                <use xlink:href="#arrow"></use>
                            </svg></a>
                    </div>
                    @endif
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <a href="{{$homesetting->about_buttonlink}}" target="_self" class="btn btn-style1"><span>{{$homesetting->about_buttontext}}</span><svg width="11.4" height="9.2">
                        <use xlink:href="#arrow"></use>
                    </svg></a>
                ...
                <div class="card-inner-row">
                    <div class="card featured to-top-left">
                        ...
                        <div class="project-button">
                            <a href="{{$service->button_link}}" title="{{$service->title}}"><span>{{$service->button_text}}</span><svg viewBox="0 0 80 80">
            ...
            <div class="portfolio-slider-inner">
                ...
                <div class="project-box-div">
                    ...
                    <div class="project-meta">
                        ...
                        <div class="project-button">
                            <a href="{{URL::to('/')}}/project/{{$project->slug}}" title="{{$project->title}}"><span>{{clean( trans('niva-backend.view_project') , array('Attr.EnableID' => true))}}</span><svg viewBox="0 0 80 80">
                                    <polyline points="19.89 15.25 64.03 15.25 64.03 59.33"></polyline>
                                    <line x1="64.03" y1="15.25" x2="14.03" y2="65.18"></line>
                                </svg></a>
                        </div>
                    ...
                    <div class="blog-item">
                        <div class="box-content p-relative">
                            <div class="box-content-body">
                                ...
                                <div class="project-button">
                                    <a href="{{URL::to('/')}}/post/{{$post->slug}}" title="{{$post->title}}"><span>{{clean( trans('niva-backend.load_more') , array('Attr.EnableID' => true))}}</span><svg viewBox="0 0 80 80">
                                            <polyline points="19.89 15.25 64.03 15.25 64.03 59.33"></polyline>
                                            <line x1="64.03" y1="15.25" x2="14.03" y2="65.18"></line>
                                        </svg></a>
                                </div>
